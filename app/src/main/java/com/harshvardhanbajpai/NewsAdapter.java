...
public class NewsAdapter extends PagerAdapter {
    Context context;
    ArrayList<NewsSilders> images;
    LayoutInflater layoutInflater;

    public NewsAdapter(Context context, ArrayList<NewsSilders> images) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        View itemView = layoutInflater.inflate(R.layout.item_imageadapter, container, false);

        TextView imageView =  itemView.findViewById(R.id.imageView);
        imageView.setText(images.get(position).getImage());

...
public class MyCustomPagerAdapter1 extends PagerAdapter {
    ...
    public MyCustomPagerAdapter1(Context context, ArrayList<GetSetImageSilders> images) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        View itemView = layoutInflater.inflate(R.layout.item_imageadapter_shop1, container, false);

        ImageView imageView = itemView.findViewById(R.id.imageView);
        Picasso.with(MyCustomPagerAdapter1.this.context).load(images.get(position).getImage()).fit().into(imageView);

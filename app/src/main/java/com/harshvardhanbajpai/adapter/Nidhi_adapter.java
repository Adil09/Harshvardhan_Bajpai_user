...
import com.harshvardhanbajpai.FilterNidhi;
...
public class Nidhi_adapter extends RecyclerView.Adapter<Nidhi_adapter.Dataholder>{

    Context context;
    private int item;
    String student_img_url,subdomain, user_id, company_id;
    ArrayList<String> selected_id= new ArrayList<>();
    ArrayList<FilterNidhi> cartcateory;


    public Nidhi_adapter(){

    }

    public Nidhi_adapter(Context context, ArrayList<FilterNidhi> mArrayList) {
    ...
    public Nidhi_adapter(Context context, int item, ArrayList<FilterNidhi> cartcateory) {
    ...
    @NonNull
    @Override
    public Nidhi_adapter.Dataholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final Nidhi_adapter.Dataholder dataholder, final int i) {
